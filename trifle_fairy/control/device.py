...
from trifle_fairy.control.connection import Connection
...
class Device:
    ...
    def __init__(self, config: Config):
        ...
        try:
            ...
            logger.info(
                f"Device initialized successfully for config: {config.config_name}")
...
if __name__ == '__main__':
    ...
    try:
        ...
        print(config.model.script.subhosts)
