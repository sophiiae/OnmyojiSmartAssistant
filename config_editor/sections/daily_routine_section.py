...
class DailyRoutineSection(QGroupBox):
    ...
    def create_widgets(self):
        ...
        self.one_summon.setChecked(self.harvest_config["one_summon"])
        grid.addWidget(self.one_summon, 2, 0)

        self.friend_love = QCheckBox("好友爱心")
        self.friend_love.setChecked(self.harvest_config["friend_love"])
        grid.addWidget(self.friend_love, 2, 1)

        self.store_sign = QCheckBox("商店签到")
        self.store_sign.setChecked(self.harvest_config["store_sign"])
        grid.addWidget(self.store_sign, 2, 2)
