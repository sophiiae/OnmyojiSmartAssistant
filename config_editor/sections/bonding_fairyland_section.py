...
class BondingFairylandSection(QGroupBox):
    ...
    def create_widgets(self):
        ...
        self.lock_team_enable.setChecked(
            self.bonding_config["lock_team_enable"])
        add_left_row(bonding_layout, [self.lock_team_enable])
    ...
    def update_config(self):
        ...
        self.bonding_config["lock_team_enable"] = self.lock_team_enable.isChecked(
        )
